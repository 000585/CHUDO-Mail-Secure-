...
const s3Service = {
    async putObj(c, key, content, metadata) {
        ...
        if (metadata.cacheControl) obj.CacheControl = metadata.cacheControl;
        if (metadata.contentDisposition) obj.ContentDisposition = metadata.contentDisposition;
        if (metadata.contentType) obj.ContentType = metadata.contentType;

const en = {
    ...
    perms: {
        ...
        "account:query": "View Email",
        "account:add": "Add Email",
        "account:delete": "Delete Email",
        "my": "Settings",
        "my:delete": "Delete User",
        "analysis": "Analytics",
        "analysis:query": "View Data",
        "user": "All Users",
        "user:query": "View User",
        "user:add": "Add User",
        "user:set-pwd": "Change Password",
        "user:set-status": "Change Status",
        "user:set-type": "Change Role",
        "user:delete": "Delete User",
        "all-email": "All Mail",
        "all-email:query": "View Email",
        "role": "Role",
        "role:add": "Add Role",
        "role:query": "View Role",
        "role:set": "Change Role",
        "role:delete": "Delete Role",
        "reg-key": "Invite Code",
        "reg-key:query": "View Code",
        "reg-key:add": "Add Code",
        "reg-key:delete": "Delete Code",
        "setting": "System Settings",
        "setting:query": "View Settings",
        "setting:set": "Change Settings",
        "user:reset-send": "Reset Send Count"
    }
};
